        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
            <div className="bg-gray-800 text-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col">
                <div className="p-6 text-center border-b border-gray-700">
                    <h2 className="text-2xl font-bold text-green-400 mb-2">Full Time Results</h2>
                    <p className="text-gray-400">{playerResult.date.toDateString()}</p>
                </div>
                ...
                <div className="p-6 overflow-y-auto flex-1">
                    <h3 className="text-lg font-semibold text-gray-300 mb-3 text-center">League Round-Up</h3>
                    <div className="space-y-2">
                        {aiResults.length > 0 ? aiResults.map(aiMatch => (
                            ...
                            <p className="text-gray-500 text-center text-sm">No other matches were played today.</p>
                        )}
                    </div>
                </div>
